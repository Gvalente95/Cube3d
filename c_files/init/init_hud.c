...
/*   Updated: 2025/04/24 13:09:40 by giuliovalen      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const t_vec2		sz = v2(md->win_sz.x * .015f);
	...
	line.y = 0;
	draw_pixels(img, line, get_v2(thick, sz.y), clr);
	line.x = 0;
	line.y = sz.y / 2 - thick / 2;
	draw_pixels(img, line, get_v2(sz.x, thick), clr);
	return (img);
}
