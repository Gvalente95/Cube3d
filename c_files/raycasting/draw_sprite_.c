...
/*   Updated: 2025/03/15 04:34:29 by giuliovalen      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cube.h"

// int	draw_single_column(t_md *md, t_image *img_data, int column_index, t_vec2 screen_position, int height)
// {
// 	int		draw_index;
// 	int		image_pixel;
// 	int		image_index;
...
// 	float screen_center = md->win_size.y / 2;
// 	screen_position.y = screen_center - (height / 2);
// 	if (column_index < 0 || column_index > md->win_size.x || screen_position.y > md->win_size.y)
// 		return (0);
// 	if (draw_position.y >= md->win_size.y)
// 		return (0);
// 	draw_index = -1;
// 	while (++draw_index < height)
// 	{
// 		if (draw_index >= img_data->size.y || draw_index + screen_position.y > md->win_size.y)
// 			break ;
// 		if (screen_position.y + draw_index >= md->win_size.y)
// 			break ;
// 		image_index = (draw_index * (img_data->size_line / 4)) + column_index;

// 		image_pixel = *(img_data->src_data + image_index);
// 		if ((image_pixel >> 24) != 0x00)
// 			continue ;
// 		draw_position = get_v2(screen_position.x, screen_position.y + draw_index);
// 		draw_pixel(md->screen, draw_position, image_pixel, -1);
// 	}
// 	return (1);
// }
