SRC_UTILS	= \
c_files/init/init_cube.c c_files/init/init_entities.c c_files/init/init_ents_data.c c_files/init/init_labels.c \
c_files/init/init_map.c c_files/init/init_map_data.c c_files/render/render.c c_files/tools/debug.c c_files/tools/free.c \
